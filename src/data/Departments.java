...
public class Departments
{
	...
	public static void populate_deps()
	{
		...
		deps.get(0).add_course(new Ocourse("Riz 1", "mogh adasi", "1998/10/1", new Date(true, 12, 2), 4, 42, 22015));
		deps.get(3).add_course(new Ocourse("Phys 1", "mogh imi", "1999/10/1", new Date(true, 11, 2), 3, 56, 36011));
	}
